...
local notesActions = require('custom.actions.notes')
...
map('n', '<leader>;fM', fileActions.convert_md_to_pdf, { desc = 'Convert markdown to PDF' })
...
map('n', '<Leader>rp', notesActions.add_notes_entry, { desc = 'Add notes entry' })
...
map('n', '<Leader>ud', fileActions.open_current_dir, { desc = 'Open directory' })
map('n', '<Leader>uc', githubActions.open_current_commit_in_github, { desc = 'Open Current Commit in GitHub' })
map('n', '<Leader>up', gitActions.openOrCreatePullRequest, { desc = 'Open existing PR or create new one' })
map('n', '<Leader>ur', linkActions.open_current_github_repo, { desc = 'Open current GitHub repo' })
...
map('n', '<Leader>uP', linkActions.open_current_github_prs, { desc = 'Open GitHub PRs tab' })
map('n', '<Leader>uW', githubActions.open_worktree_pr, { desc = 'Open worktree PR in browser' })
map('n', '<Leader>uu', linkActions.open_useful_link, { desc = 'Open useful link' })
map('n', '<Leader>uU', linkActions.open_private_useful_link, { desc = 'Open private useful link' })
map('n', '<Leader>ug', githubActions.list_org_repos_and_open, { desc = 'List Org Repos' })
map('n', '<Leader>uG', githubActions.list_org_repos_and_open, { desc = 'List Org Repos (alt)' })
map('n', '<Leader>us', linkActions.search_google, { desc = 'Search Google' })
map('n', '<Leader>uF', linkActions.open_firefox_container, { desc = 'Open Firefox container' })
