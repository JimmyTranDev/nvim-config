...
map('n', 'gj', ':cnext<CR>', { desc = 'Next quickfix item' })
map('n', 'gk', ':cprev<CR>', { desc = 'Previous quickfix item' })
...
map('n', '<leader>hfa', promptActions.folderPrompt(prompts.accessibilityImproveReactPrompt), { desc = '♿ Copy accessibility prompt' })
map('n', '<leader>hfi', promptActions.folderPrompt(prompts.testIdsPrompt), { desc = '󰀫 Copy TestId prompt' })
map('n', '<leader>hfs', promptActions.folderPrompt(prompts.storyGeneratePrompt), { desc = 'Copy story prompt' })
...
map({ 'n', 'v' }, '<leader>hm', promptActions.prompt(prompts.marketStatusPrompt), { desc = '📈 Market status' })
map({ 'n', 'v' }, '<leader>hn', promptActions.promptNews(), { desc = '📰 News' })
