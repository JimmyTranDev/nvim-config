...
M.projectNameToRouteObject = jsonUtils.parse_json_from_file(expand('$HOME/Programming/JimmyTranDev/secrets/technical_links.json'))
M.projectNames = {}
for projectName, _ in pairs(M.projectNameToRouteObject) do
  table.insert(M.projectNames, projectName)
end

M.usefulLink = jsonUtils.parse_json_from_file(expand('$HOME/Programming/JimmyTranDev/secrets/useful_links.json'))
M.usefulLinkNames = {}
