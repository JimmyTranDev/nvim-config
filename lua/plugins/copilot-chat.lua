return {
  ...
  keys = {
    ...
    { mode = 'v', '<leader>kk', ':CopilotChat<CR>', desc = 'Copilot chat with selection', silent = true },

    { mode = 'v', '<leader>kF', ':CopilotChat Please improve this code<CR>', desc = 'Copilot improve selection', silent = true },
