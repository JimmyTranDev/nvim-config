return {
  ...
  keys = {
    ...
    { '<leader><leader>aa', function() return require('opencode').operator('@this ') end, mode = { 'n', 'x' }, expr = true, desc = 'Add range to opencode' },
    { '<leader><leader>al', function() return require('opencode').operator('@this ') .. '_' end, mode = 'n', expr = true, desc = 'Add line to opencode' },
